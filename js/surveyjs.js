...
if(index==0)
    ...
    {
        $(".Carousel-Controller-Nav").css("display", "none");
          $("#dot2").css("color", "#e040fb");
        $("#dot1").css("color", "#CCC");
        $("#dot3").css("color", "#CCC");
        $("#tofield3").fadeIn(500);
        $("#backfield").fadeIn(500);
    }
    else if(index==2)
    {
...
$("#backfield").click(function()
                      {
        if($("#field1").hasClass("active"))
    {
      
        $("#field1").removeClass("active");
        $("#field1").fadeOut(200);
        
         $("#field4").delay(200).fadeIn(500);
        $("#field4").addClass("active");
           $("#pabout").stop().html("3&#8228; СТИЛИСТИКА ДИЗАЙНА САЙТА").hide(0).fadeIn("fast");
         $("#tofield3 font").stop().html("Завершить").hide(0).fadeIn("fast");
       
    }else if( $("#field3").hasClass("active"))
    {
       

         $("#field3").removeClass("active");
      $("#field1").addClass("active");
                     $("#pabout").css("margin-bottom","3%");  
                     $("#pabout").stop().html("1&#8228; ОБЩАЯ ИНФОРМАЦИЯ О КОМПАНИИ И ПРОЕКТЕ").hide(0).fadeIn("fast");
                            //$("#tofield3 font").stop().html("Продолжить").hide(0).fadeIn("fast");

                     $("#field3").fadeOut(200);
                     $("#field1").delay(200).fadeIn(500);

       
    }else if($("#field4").hasClass("active"))
    {
         $("#field4").removeClass("active");
        $("#field4").fadeOut(200);
        
         $("#field3").delay(200).fadeIn(500);
        $("#field3").addClass("active");
           $("#pabout").stop().html("2&#8228; СТРУКТУРА САЙТА И ОСОБЕННОСТИ РАЗРАБОТКИ").hide(0).fadeIn("fast");
         $("#tofield3 font").stop().html("Продолжить").hide(0).fadeIn("fast");
    }
    
});

$("#tofield3").click(function()
{
       ...
       var survey = "";
        for(i=1;i<22;i++)
        {
            ...
            { //alert(survey);
                ...
                $("#tofield3").fadeOut(300);
                $("#backfield").fadeOut(300);
                   //alert(survey);
                	var current_time = 123;
			var dataString = 'current_time='+ current_time + '&tasktitle=' + survey;
